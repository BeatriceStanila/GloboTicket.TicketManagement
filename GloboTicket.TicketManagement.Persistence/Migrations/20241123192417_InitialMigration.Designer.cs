...
namespace GloboTicket.TicketManagement.Persistence.Migrations
{
    ...
    [Migration("20241123192417_InitialMigration")]
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Artist = "John Egbert",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 5, 23, 19, 24, 16, 873, DateTimeKind.Local).AddTicks(1454),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 8, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(1698),
                        ...
                        new
                        {
                            ...
                            Artist = "DJ 'The Mike'",
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 3, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(1853),
                        ...
                        new
                        {
                            ...
                            CategoryId = new Guid("b0788d2f-8003-43c1-92a4-edc76a7c5dde"),
                            Date = new DateTime(2025, 3, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(1907),
                        ...
                        new
                        {
                            ...
                            Artist = "Many",
                            CategoryId = new Guid("fe98f549-e790-4e9f-aa16-18c2292a2ee9"),
                            Date = new DateTime(2025, 9, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(1953),
                        ...
                        new
                        {
                            ...
                            Artist = "Nick Sailor",
                            CategoryId = new Guid("6313179f-7837-473a-a4d5-a5571b43e6a6"),
                            Date = new DateTime(2025, 7, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(2036),
            ...
            modelBuilder.Entity("GloboTicket.TicketManagement.Domain.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(4639),
                            OrderTotal = 400,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(5611),
                            OrderTotal = 135,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(5651),
                            OrderTotal = 85,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(5681),
                            OrderTotal = 245,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(5711),
                            OrderTotal = 142,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(5756),
                            OrderTotal = 40,
                        ...
                        new
                        {
                            ...
                            OrderPaid = true,
                            OrderPlaced = new DateTime(2024, 11, 23, 19, 24, 16, 878, DateTimeKind.Local).AddTicks(5784),
                            OrderTotal = 116,
                            UserId = new Guid("7aeb2c01-fe8e-4b84-a5ba-330bdf950f5c")
                        });
                });
